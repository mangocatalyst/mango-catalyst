...
2. **On light bands, amber is button fill only.** Amber as text, icon, or link on light fails AA (1.91:1). Links and accents on light go navy. On dark bands amber text is fine (8.68:1 on `base`).
...
| **Big Shoulders Variable** | `BigShoulders-Variable-latin.woff2`, weight 100 to 900 | Display: H1/H2 headlines, uppercase, industrial. Alternate on file: Archivo |
...
| Section lead | Inter 400 | 1.05rem, sm: 1.125rem, max-width 44rem | 1.65 leading |
| Body | Inter 400 | 1rem to 1.125rem, never under 16px on mobile (iOS zooms forms) | 1.6 leading |
| Small / caption | Inter 400 to 500 | 0.875rem, `muted` | |
| Button label | Inter 600 | 1rem (sm: 0.925rem) | -0.006em |
| Price figures | Inter 800, tabular figures | 2.5rem to 3.5rem | |
| Wordmark | Inter 600 | 1.05rem, tracking tight | |

Rules: left-align everything (short headings may center), no justified text, body lines 60 to 75 characters max, generous vertical whitespace between bands.
