...
- **Audience:** overwhelmed owners + office/admin staff. Trades-first, not trades-only. No public revenue-band qualifier (decided 2026-07-01): qualify on pain plus under-25 headcount. **PHI stance (revised 2026-07-06, Bryan):** the FAQ patient-health-records carve-out is REMOVED. The MN-ITS Helper extension is offered openly (its own page at /mn-its) on the strength of its local-only design: no servers, no egress, claim data never leaves the user's machine. Custom PHI-touching *cloud* automations remain out of scope until the attorney review that rides the LLC gate. (Old stance for history: no PHI-touching automations until attorney review, medical/dental out of the FAQ fit sentence.)
...
- **Product terms (decided 2026-07-29):** there are TWO standalone products besides the retainer, and this brief previously recorded neither, which is how the site and the outreach drifted apart. Owner dashboard (standalone 2026-07-16) and commission tracker (priced 2026-07-29): **each $795 setup + $125/month**, month to month, cancel anytime, no retainer required. Buying both is two setups and two monthlies; there is no bundle. Tracker setup carries one guard clause, because encoding a shop's real pay agreements varies far more than wiring a dashboard: if $795 does not cover a shop's agreements, the number is stated before work starts.
- **Success unit (decided 2026-07-29):** land with a product, expand to the retainer. **Primary counter is product customers at $795 + $125/month; expansions to the $1,000/month retainer are a lagging secondary counter and never a threshold**, since no expansion rate exists yet. A $125 product inquiry is not a $1,000 seat, and copy, outreach and the capacity model must all use this same unit. Capacity splits accordingly: products are low-touch and bounded by support load (unmeasured, no published number), the retainer stays bounded at 2 to 3. Honesty consequence, paid deliberately: /dashboards no longer promises "nobody will steer you into one" (a promise this model does not keep) and instead promises the customer starts any expansion conversation. Full record: vault note `mc-success-unit-decision-2026-07-29`.
