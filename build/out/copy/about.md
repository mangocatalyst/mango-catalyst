...
## Page metadata (from seo-spec section 2.4)

- **Title:** `Automation Consultant in Duluth, MN | Mango Catalyst`
- **Meta description:** `Mango Catalyst is Bryan, an automation consultant in Duluth, MN who ran service operations inside a real shop. One person who builds it, runs it, and answers.`
- **Canonical:** `/about`
- **Schema:** `breadcrumbLd([Home, About])`
- **Imagery note (00 people rule):** the headshot is a REAL photo of Bryan, AI-stylized to match the site. If it is not ready at build time, ship this page type-only. Never a generated person.
...
**(Answer-first opening: who am I hiring?)**
...
My background is a little weird, and that's the point. I spent 20 years as a photographer running my own business, where every job had a hard deadline and no do-overs. I built and sold e-commerce companies. I general-contracted the build of my own home on 15 acres outside Duluth. Then I ran service operations for a real service business, and that's where I got obsessed with building systems that made the work easier: the scheduling, the phones, the daily numbers, the same info typed into three screens. I know that work because I did that work.
...
## Pull-quote (optional, set large, amber)

"I'd rather spend the time to build one system that runs 100 times than do the same task 100 times."

## Closing CTA

**Line:** If your week is disappearing into office busywork, let's look at it together.
