...
## Page metadata (from seo-spec section 2.2)

- **Title:** `Automation Services for Small Businesses | Mango Catalyst`
- **Meta description:** `Invoicing, lead follow-up, scheduling, reporting, and data entry that run on their own. We connect the tools you already pay for. Book a 15-minute fit call.`
- **Canonical:** `/services`
- **Schema:** one `serviceLd({ name: "Business Automation Services", ... })` node + `breadcrumbLd([Home, Services])`. One page = one Service entity; the cards are `<h3>` content, not separate Service nodes.
...
## Service cards (each an `<h3>`; first sentence answers "can I automate X?")
...
The mind-numbing typing and copy-paste work can be handed off to a system that doesn't get tired or make typos at 4:45 on a Friday. If you want to see what that work is really costing you, read [what manual data entry costs](/guides/manual-data-entry-cost).
...
**Line:** Fifteen minutes, no pitch. We look at one task and I tell you straight whether it can run itself.
