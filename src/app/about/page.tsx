...
const STORY: string[] = [
  ...
  "These days the building is the whole job. The one product I've shipped on my own is a browser extension that automates medical claim data entry into Minnesota's provider billing portal, built privacy-first so everything runs on the user's own machine and sensitive data never leaves the building. Day to day I work in ServiceTitan, Google Workspace, and Slack, and if your tool has an API, I can probably wire it in.",
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <Section tone="base" containerClassName="pb-[clamp(3rem,6vw,4.5rem)]">
          ...
          <p className="mt-8 max-w-[46rem] text-[1.15rem] leading-[1.65] text-body sm:text-[1.3rem] lg:max-w-[54rem]">
            {
        ...
        >
          <div className="max-w-[46rem] space-y-7 border-l border-hairline pl-6 sm:pl-10 lg:max-w-[54rem] lg:text-[1.2rem]">
            {STORY.map((paragraph) => (
              <p
