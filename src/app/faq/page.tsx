...
const FAQ_ITEMS: { question: string; answer: AnswerPart[] }[] = [
  ...
  },
  {
    ...
    answer: [
      "Home-service shops drowning in repetitive office work without a systems person on the payroll, usually under 25 people: HVAC, plumbing, electrical, roofing, and the trades around them. I started in ",
      { text: "trades and home services", href: "/industries/hvac-automation" },
      " because that's where I come from, and it's where the tools, the seasons, and the busywork are ones I already know. If your team is re-typing the same information into multiple screens, chasing follow-ups by memory, or doing invoices after hours, we should talk.",
    ],
  },
  {
